...
review (Section~8.3). \textbf{Update:} The full review protocol has now been deposited 
post-hoc in OSF under DOI: \url{https://doi.org/10.XXXXX/XXXXX} [INSERT DOI HERE], 
enabling independent verification of adherence to the pre-specified methodology. 
The authors commit to depositing all future review protocols in OSF prior to data 
collection.}
...
\medskip
\noindent\scriptsize\textsuperscript{\textdagger}\textit{Energy metric clarification:} 
The column ``E'' in Table~\ref{tab:study_chars} counts studies reporting 
\textit{direct hardware measurement} of energy consumption (6 of 33, 18.2\%). 
The 39.4\% figure reported in the Abstract and Section~4.2 (13 of 33) includes 
studies reporting energy estimates from simulation models. This distinction is 
necessary because simulation-based energy estimates cannot be directly compared 
with hardware measurements. See Supplementary Table~S1 for per-study metric 
classification and extraction methodology.
