...
\begin{itemize}
  ...
  \item \textbf{Inter-rater agreement:} Cohen's kappa for dual-reviewer study selection ($\kappa=0.91$, 95\% CI [0.84, 0.98]) is reported in Section~3.2, confirming almost perfect agreement (Landis \& Koch, 1977). The second reviewer is Dr.\ Hernán de la Garza Gutiérrez (Tecnológico Nacional de México, campus Chihuahua II).
