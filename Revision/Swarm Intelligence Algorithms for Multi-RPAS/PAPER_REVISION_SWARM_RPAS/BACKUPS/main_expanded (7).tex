...
Search query limitations & Relevant papers using unlisted algorithm names or non-indexed terminology may be missed & Query refined iteratively with IEEE Thesaurus terms and proximity operators; sensitivity test with 5-paper gold-standard set confirmed 100\% recall; supplemented with forward/backward snowballing via Research Rabbit \\
