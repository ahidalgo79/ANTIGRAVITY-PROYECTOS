...
\item \textbf{Single-reviewer title/abstract screening:} Si bien el cribado inicial de títulos y resúmenes fue realizado por un único revisor, implementamos varias estrategias para mitigar este riesgo inherente. La búsqueda booleana fue rigurosamente validada con un conjunto estándar de oro de cinco artículos, logrando un 100% de recall. Se aplicó un enfoque de cribado liberal, promoviendo a la revisión de texto completo todos los registros fronterizos. Esta evaluación posterior, realizada por dos revisores, demostró un acuerdo casi perfecto (kappa=0.91). Además, la consistencia fue asegurada mediante una auditoría asistida por IA y la trazabilidad completa del proceso se garantiza a través de nuestro protocolo registrado en OSF (DOI: 10.17605/OSF.IO/64DQ9), reforzando la fiabilidad de nuestros hallazgos.
\end{itemize}
...
Table~\ref{tab:temporal} shows that publications concentrate in 2021--2022 (23 of 33 papers, 69.7\%), with the remaining 10 papers (30.3\%) published in 2023 ($n=9$) and early 2024 ($n=1$). The 2021--2022 peak coincides with the post-pandemic acceleration of agricultural automation investment and the proliferation of new SI algorithm variants. The lower volume in 2023--2024 likely reflects two factors: (i) a "quality filter effect" where standardisation and hardware-validation requirements became more stringent in high-impact venues, and (ii) indexing lags of 3--6 months at major databases, as the literature search was conducted on 2024-03-16.
