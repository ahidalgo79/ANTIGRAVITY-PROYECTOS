...
Table~\ref{tab:metrics} and Figure~\ref{fig:metrics} reveal a critical standardisation deficit across the reviewed corpus. Over the full corpus of 31 included studies, only 14 (45.2\%) report execution time, 13 (41.9\%) report energy consumption, and 7 (22.6\%) specify convergence criteria. The 7 secondary review articles (S10, S11, S14, S15, S17, S31, S32) returned null for all three metrics, as expected; when calculated over the 24 primary research studies exclusively, the reporting rates are 14 of 24 (58.3\%), 13 of 24 (54.2\%), and 7 of 24 (29.2\%), respectively. No study in the corpus---primary or review---reports all three metrics simultaneously alongside an agricultural-domain metric such as coverage rate per hectare or spray overlap coefficient.
