...
%% ---
%% AUDITORIA FORENSE PRE-SUBMISSION 2026-04-24 — Tarea t25 (6 errores criticos):
%% t25-C01 — Tabla 7: S24 eliminado de fila ACO (era GWO); ACO puro = S01+S19 (n=2).
%%            PSO E% corregido de 20.0 a 30.0 (S09+S12+S20 = 3/10).
%%            Score_mu PSO: 1.4 → 1.5. Nota de pie $^b$ reescrita con aclaracion
%%            explicita anti-doble-conteo de S06.
%% t25-C02 — Sec. 5.5: Monitoring 15/22 → three/22 (S01,S05,S08);
%%            Spraying 8/22 → one/22 (S13); Mapping 4/22 → one/22 (S09);
%%            General coordination 16/22 → 17/22 añadido como parrafo explícito.
%%            Todos los porcentajes verificados contra columna App. de Table 4.
%% t25-C03 — Sec. 6.3: "None of the eight spraying-focused primary studies" →
%%            "The one spraying-focused primary study (S13, Chu et al.)".
%%            Cifra de wind gap corregida de 25/29 (86.2%) a 20/29 (69.0%).
%% t25-C04 — Caption Figure 2: eliminada referencia erronea a S06 como ACO study;
%%            "Other SI Variants (five papers, 17.2%)" corregido a tres papers (10.3%).
%% t25-C05 — Sec. 3.8 MMAT: denominador Q3 corregido de "14 of 29 studies, 48.3%"
%%            a "14 of 22 primary studies, 63.6%".
%% t25-C06 — Confirmado: nota interna "Pre-submission verification required"
%%            ya no existe en el archivo (eliminada en tarea t9 previa). OK.
%% Verificacion aritmetica t25:
%%   Table 7 PSO: T=8/10=80.0% | E=3/10=30.0% | C=4/10=40.0% | Score=(8+3+4)/10=1.5 OK
%%   Table 7 ACO pure: T=0/2=0.0% | E=0/2=0.0% | C=1/2=50.0% | Score=0.5 OK
%%   Sec 5.5 App totals: 3+1+1+17=22 primarios OK
...
\item PSO dominates SI algorithms: 9 of 29 studies (31.0\%; 40.9\% of 22 primary studies)
\item ACO and SSA are frequently used, appearing in two studies each (6.9\%)
...
(9 of~29, 31.0\%; 9 of~22 primary, 40.9\%). All 22~primary studies
...
(86.2\%). Metric reporting is sparse: 11 of~29~(37.9\%) report execution
time, four~(13.8\%) quantitative energy consumption, and nine~(31.0\%)
...
{\sloppy Swarm Intelligence (SI) algorithms---computational methods inspired by the
collective behaviour of social organisms---have emerged as the dominant
metaheuristic paradigm for multi-UAV path planning
\cite{dorigo2006,kennedy1995,blum2008} \cite{yang2010,beni2005,bonabeau1999,yang2013}.\par}
...
\begin{itemize}
  ...
  only 11 (37.9\%) report quantitative execution time, four (13.8\%) report
  energy consumption with explicit numerical values and units, and nine (31.0\%)
  specify convergence criteria. When calculated over the 22~primary research
  studies exclusively, these rates are 11 of~22 (50.0\%), four of~22 (18.2\%),
  and nine of~22 (40.9\%), respectively.
...
\begin{itemize}
  ...
  (14 of~29; though only 11 were confirmed after manual verification), 13.8\%
  for energy consumption (four of~29), and 34.5\% for convergence criteria (ten of~29).
...
63.6\%), and four Low ($Q < 0.40$; 18.2\%). Verification: $4+14+4=22$ \checkmark.
...
%% t24-C10: MMAT n=22: H=6(27.3%), M=14(63.6%), L=2(9.1%)
%% Verificacion: 6+14+2=22 \checkmark
...
instrument. Verification: $6+14+2=22$ \checkmark. Note on rounding: $6/22=27.27\%
...
%% t25-C05 (2026-04-24): Denominador Q3 corregido. MMAT aplica solo a n=22 primarios.
tell' responses was Q3 (measurement validity and reproducibility, 14 of
22~primary studies, 63.6\%), reflecting the common practice of reporting simulation
...
\multicolumn{2}{l}{\textbf{Summary (n=29)}}     & PSO: 9 (31.0\%)  & Sim: 22 (75.9\%) & Multi: 7 (24.1\%) & 1--25 & 11 (37.9\%) & 4 (13.8\%) & 9 (31.0\%) & \\
\multicolumn{2}{l}{\textbf{Primary only (n=22)}} & PSO: 9 (40.9\%)  & Sim: 22 (100\%)  & Multi: 7 (31.8\%) & 1--25 & 11 (50.0\%) & 4 (18.2\%) & 9 (40.9\%) & \\
\bottomrule
\multicolumn{10}{@{}l@{}}{\scriptsize App.: Mon.~=~Monitoring, Spr.~=~Spraying, Map.~=~Mapping, Gen.~=~General. N/A = review articles (no original experiments). S06 (PSO+ACO) and S26 (APF+PSO) classified under PSO for consistency with Table~5.}
\end{tabular*}
...
with nine papers (31.0\% of all 29~studies; 40.9\% of the 22~primary research
...
two papers (6.9\% of all~29; 9.1\% of 22~primary).
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figures/Figure2_Algorithm_Distribution}
%% t25-C04 (2026-04-24): Caption Fig. 2 corregida.
%% S06 es PSO+ACO clasificado bajo PSO, NO bajo ACO. Eliminada referencia erronea.
%% "Other SI Variants" = S07+S08+S21 (3 estudios, 10.3%), no 5.
\caption{Distribution of swarm intelligence algorithms across 29~reviewed studies
(2021--2025). PSO dominates with nine papers (31.0\% of the full corpus; 40.9\%
of the 22~primary research studies), followed by review articles (24.1\%), ACO
(6.9\%), and ABC (10.3\%). ``Other SI Variants'' (three papers, 10.3\%) comprises
SFLA~(S08), Fuzzy/SIGPAF~(S07), and Wolf Pack~(S21). Hybrid studies PSO+ACO~(S06)
and APF+PSO~(S26) are classified under PSO; S24~(Rao et al.) is classified under GWO.}
...
\midrule
PSO          & Swarm  &  9 & 31.0 & 40.9 \\
Review       & Review &  7 & 24.1 & N/A  \\
ACO          & Swarm  &  2 &  6.9 &  9.1 \\
ABC          & Swarm  &  3 & 10.3 & 13.6 \\
SSA          & Swarm  &  2 &  6.9 &  9.1 \\
GWO          & Swarm  &  1 &  3.4 &  4.5 \\
DBO          & Swarm  &  0 &  0.0 &  0.0 \\
NOA          & Swarm  &  1 &  3.4 &  4.5 \\
DOA          & Swarm  &  1 &  3.4 &  4.5 \\
Other SI Variants$^*$ & Swarm & 3 & 10.3 & 13.6 \\
\midrule
...
29~included studies, only 11 (37.9\%) report execution time, four (13.8\%)
report energy consumption with explicit numerical values and units, and nine
(31.0\%) specify convergence criteria. The seven secondary review articles
returned null for all three metrics, as expected; when calculated over the
22~primary research studies exclusively, the reporting rates are 11 of~22
(50.0\%), four of~22 (18.2\%), and nine of~22 (40.9\%), respectively. No study
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.90\textwidth]{figures/Figure3_Metrics_Availability}
...
22~primary research studies (n=22). Only 11 of~29 (37.9\%) report execution
...
\midrule
Execution Time       & 11 & 37.9 & 50.0 \\
Energy Consumption   &  4 & 13.8 & 18.2 \\
Convergence Criteria &  9 & 31.0 & 40.9 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
%% t25-C01 (2026-04-24): Tabla 7 corregida.
%% PSO: S06,S09,S12,S13,S16,S20,S22,S25,S26,S27 → 10 estudios; E=3/10=30.0%
%% ACO puro: S01, S19 solamente (n=2). S06=PSO+ACO contado en PSO, no aqui.
%% S24 (Rao) = GWO, eliminado de la fila ACO.
PSO (hybrids)$^{a}$
  & S06, S09, S12, S13, S16, S20, S22, S25, S26
  & 9 & 77.8 & 33.3 & 44.4 & 1$^{\ddagger}$ & 1.55 \\
ACO (pure)$^{b}$
  & S01, S19
  & 2  & 0.0  & 0.0  & 50.0 & 0 & 0.5 \\
ABC (hybrids)
  & S02, S04, S18
  & 3  & 0.0  & 33.3 & 100.0 & 0 & 1.33 \\
SSA (hybrid)
  & S03, S05
  & 2  & 0.0  & 0.0  & 0.0  & 0 & 0.0 \\
Other SI$^{c}$
...
\textbf{All primary}
  ...
  & \textbf{22} & \textbf{50.0} & \textbf{18.2} & \textbf{40.9} & \textbf{1} & \textbf{1.09} \\
\bottomrule
\end{tabularx}
\begin{minipage}{\linewidth}
\scriptsize\medskip
$^{a}$ PSO hybrids classified under PSO: PSO+ACO (S06), PSO hybrid (S12), APF+PSO (S26).
S09, S12, and S20 report quantitative energy (E\,=\,30.0\%: three of~ten PSO studies).\\
$^{b}$ ACO pure studies: S01 (Chen et al.) and S19 (Shafiq et al.). S06 (Mathew et al.,
PSO+ACO hybrid) is counted exclusively under the PSO row to avoid double-counting.
S24 (Rao et al.) is classified under GWO, not ACO.\\
...
Verification: $51+52+39+29=171$ \checkmark.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.70\textwidth]{figures/Figure4_Gaps_by_Dimension}
%% t24-C03: 171 gaps
...
\begin{table}[htbp]
\centering
\caption{Research gaps by dimension (total = 171). Verification: $51+52+39+29=171$ \checkmark.}
...
Figure~\ref{fig:gaps_priority}). Verification: $76+88+7=171$ \checkmark.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.72\textwidth]{figures/Figure5_Gaps_by_Priority}
%% t24-C03: 171 gaps
...
\begin{table}[htbp]
\centering
\caption{Research gaps by priority level. Verification: $76+88+7=171$ \checkmark.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/Figure6_Top10_Critical_Gaps}
...
\label{tab:top10}
\begin{tabular}{clrr>{\raggedright\arraybackslash}p{5cm}}
\toprule
...
3  & No wind/weather modelling            & 20 & 69.0  & \\
4  & Single-UAV focus (no swarm)$^{(\S)}$ & 15 & 51.7  & 15/22 primary (68.2\%); upper bound \\
...
%% t25-C02 (2026-04-24): Sec. 5.5 corregida. Conteos verificados contra columna
%% App. de Table 4: Mon.=S01,S05,S08 (3); Spr.=S13 (1); Map.=S09 (1); Gen.=17.
\textbf{Monitoring applications} (three of~22 primary studies, 13.6\% of primary;
10.3\% of n=29; studies S01, S05, S08): Show the highest prevalence of Methodological
gaps, particularly absent convergence criteria.

\textbf{Spraying applications} (one of~22 primary studies, 4.5\% of primary;
3.4\% of n=29; study S13): The sole spraying study does not model wind or weather
conditions. Wind drift of pesticide or fertiliser droplets is both an efficacy issue
and a regulatory compliance issue, making this the most operationally critical gap
pattern in the corpus despite its single-study basis.

\textbf{Mapping applications} (one of~22 primary studies, 4.5\% of primary;
3.4\% of n=29; study S09): Shows the lowest overall gap density, likely because
3D mapping missions have more established simulation environments.

\textbf{General coordination} (17 of~22 primary studies, 77.3\% of primary;
58.6\% of n=29): The dominant category. Studies classified as general coordination
address path planning, task allocation, or trajectory optimisation without explicit
agricultural mission specialisation. Gap patterns in this group mirror the
full-corpus distributions reported in Sections~5.1--5.3.

\subsection{Gap Patterns by Algorithm Family}

PSO-based studies (nine of~29, 31.0\%) show relatively lower prevalence of
metric inconsistency (execution time reported in seven of~nine PSO studies,
77.8\%, vs.\ 11 of~29 overall, 37.9\%) but higher prevalence of static
environment assumptions.

ACO-based studies (two of~29, 6.9\%) show the most complete metric reporting
among multi-study families---both ACO studies report at least two of the
...
First, the dominance of Particle Swarm Optimisation (PSO, nine of~29 studies,
31.0\%; nine of~22 primary studies, 40.9\%) reflects the algorithm's
...
%% t25-C03 (2026-04-24): Sec. 6.3 corregida — "eight spraying studies" residual
%% del corpus anterior (n=33). Corpus actual: solo S13 es Spr.
The absence of wind and weather modelling in 20 of~29 included studies (69.0\%)
...
issue and a regulatory compliance issue. The one spraying-focused primary study
in this corpus (S13, Chu et al.) does not model this regulatory constraint,
representing a complete absence of wind modelling in spraying-specific research.

\subsection{Metric Inconsistency: Implications for Algorithm Selection}
\label{sec:metrics_disc}

Over the full corpus of 29~studies, only 11 (37.9\%) report execution time,
four (13.8\%) report energy consumption with explicit numerical values and units,
and nine (31.0\%) specify convergence criteria; over the 22~primary research
studies, these rates are 11 of~22 (50.0\%), four of~22 (18.2\%), and nine of~22
(40.9\%), respectively. No study reports all three simultaneously alongside
...
deployment. The research agenda proposed here addresses the most fundamental of
these through three synergistic priorities (Table~\ref{tab:priorities}). These
priorities target the core clusters identified in Section~5.4 rather than
providing a one-to-one mapping for the entire 171-gap taxonomy.
...
\begin{tabularx}{\textwidth}{clrr>{\raggedright\arraybackslash}X}
\toprule
...
2 & Experimental validation: real UAVs in field         & 29 & Very High & Staged Validation Protocol as community norm \tabularnewline
...
\begin{enumerate}
  \item \textbf{PSO dominates the algorithm landscape} (nine of~29 studies,
  31.0\%; nine of~22 primary studies, 40.9\%), followed by review articles
  (seven of~29, 24.1\%), ACO variants (two of~29, 6.9\%), and ABC (three of~29, 10.3\%).
  ...
  sole spraying-focused primary study (S13), wind and weather modelling is
  completely absent (1/1, 100\%)---a particularly acute finding since wind drift
  affects both pesticide efficacy and regulatory compliance.

  \item \textbf{Metric reporting is fragmented}: over the full corpus,
  only 11 of~29 (37.9\%) report execution time, four of~29 (13.8\%) quantitative
  energy consumption, and nine of~29 (31.0\%) convergence criteria; over the
  22~primary studies, these rates are 11 of~22 (50.0\%), four of~22 (18.2\%),
  and nine of~22 (40.9\%), respectively.
