...
% fontspec reemplaza a fontenc y gestiona la codificación 'TU' automáticamente [1]
\usepackage{fontspec} 
\setmainfont{Times New Roman} % Usa fuentes del sistema directamente [2, 3]

% unicode-math permite acceso a todos los símbolos matemáticos Unicode [1]
% Reemplaza a paquetes antiguos como mathptmx o amssymb [1]
...
\usepackage{tabularx}
\usepackage{multirow}
\usepackage{graphicx} % Estándar actual para PDF/PNG/JPG [1]
\usepackage{hyperref}
\usepackage{xcolor}
...
\usepackage{rotating}
\usepackage{pifont}
\AtBeginDocument{\renewcommand{\checkmark}{\ding{51}}} % Redefinition postponed to avoid 'undefined' error with unicode-math
\usepackage{tikz}
...
\begin{document}
% El contenido debe guardarse imperativamente en codificación UTF-8 [4]
\begin{frontmatter}
%% ---- HIGHLIGHTS (5 bullets, ≤85 chars each) ----
\begin{highlights}
\item PRISMA 2020 review screened 502 records; 33 studies (2021--2025) retained
\item PSO dominates SI algorithms, applied in 10 of 33 studies (30.3\%)
\item ACO is second most used, appearing in 3 of 33 studies (9.1\%)
\item 171 research gaps classified: Technological, Practical, Methodological, Theoretical
\item AgriSwarm-Bench proposed: 6 standardised metrics for UAV swarm deployment
\end{highlights}
...
\begin{abstract}
	\textbf{Background:} Multi-UAV systems are increasingly deployed in precision agriculture for crop monitoring, spraying, and field mapping. Coordinating multiple aerial agents introduces complex optimisation challenges in path planning under dynamic conditions. Swarm intelligence (SI) algorithms offer scalability, distributed decision-making, and robustness to address these challenges.

	\textbf{Objective:} This systematic review analyses advances in SI-based multi-UAV path planning for precision agriculture and identifies critical research gaps limiting real-world deployment.

	\textbf{Methods:} Following PRISMA~2020 guidelines, a systematic search across IEEE~Xplore, ScienceDirect, and SpringerLink identified 502~records (2021--2025). After screening, 33~studies met all criteria: 26~primary articles and 7~secondary reviews. Data were extracted on algorithm type, metrics, environmental modelling, and experimental validation. Limitations were categorised across four dimensions: Technological, Practical, Methodological, and Theoretical.

	\textbf{Results:} Particle Swarm Optimisation dominates the corpus (10 of 33, 30.3\%). All 26~primary studies rely exclusively on simulation. Wind and dynamic obstacles are absent in 25 of 33~studies~(75.8\%). Metric reporting is sparse: 14 of 33~(42.4\%) report execution time, 13~(39.4\%) energy consumption, and 7~(21.2\%) convergence criteria. A total of 171~research gaps were identified and classified across four dimensions.

	\textbf{Conclusions:} SI-based multi-UAV path planning remains simulation-oriented and lacks standardised benchmarks. This study provides the first structured gap analysis---171~gaps across Technological~(51), Practical~(52), Methodological~(39), and Theoretical~(29) dimensions---and proposes AgriSwarm-Bench, an open framework to accelerate experimental validation and standardised evaluation of swarm-based agricultural UAV systems.
\end{abstract}
...
\begin{itemize}
  %% CORRECCIÃ“N t8a: cada bullet declara numerador, denominador y porcentaje.
...
\midrule
\textbf{Population} & Peer-reviewed studies (2021--2025) addressing path planning, trajectory planning, or coverage planning for multi-UAV systems in precision agriculture contexts (crop monitoring, spraying, field mapping, yield estimation). \\
...
in Page et al.\ (2021). Search conducted on 2026-03-16 across IEEE Xplore, 
...
The composite quality score for each study was computed as (Eq.~\eqref{eq:drs}):
\begin{equation}
...
\midrule
S01 & Chen et al.\ \cite{chen2021}$^\dagger$ & ACO & Sim & Multi-agent & 2--10 & -- & -- & -- & Mon. \\
S02 & Lin et al.\ \cite{lin2022}$^\dagger$ & ABC & Sim & Framework-only & 1 & -- & -- & -- & Gen. \\
S03 & Liu et al.\ \cite{liu2021cassa}$^\dagger$ & SSA & Sim & Framework-only & 1 & -- & -- & -- & Gen. \\
S04 & Liu et al.\ \cite{liu2021disaster}$^\dagger$ & GA+ABC & Sim & Framework-only & 1--3 & -- & -- & -- & Gen. \\
...
S09 & Phung \& Ha \cite{phung2021}$^\dagger$ & PSO & Sim & Framework-only & 1 & \checkmark & -- & -- & Map. \\
...
S12 & Yu et al.\ \cite{yu2021}$^\dagger$ & PSO hybrid & Sim & Framework-only & 1 & -- & -- & \checkmark & Gen. \\
S13 & Chu et al.\ \cite{chu2022}$^\dagger$ & PSO & Sim & Framework-only & 1 & \checkmark & -- & \checkmark & Spr. \\
...
S18 & Selma et al.\ \cite{selma2022}$^\dagger$ & ABC & Sim & Framework-only & 1 & -- & -- & -- & Gen. \\
S19 & Shafiq et al.\ \cite{shafiq2022}$^\dagger$ & ACO & Sim & Multi-agent & 2 & -- & -- & -- & Gen. \\
...
S22 & Wang et al.\ \cite{wang2025}$^\dagger$ & ABC+BAS & S+T & Framework-only & 1 & \checkmark & -- & -- & Gen. \\
S23 & Deng et al.\ \cite{deng2023}$^\dagger$ & PSO & Sim & Framework-only & 1 & \checkmark & -- & \checkmark & Gen. \\
S24 & Xiao et al.\ \cite{xiao2025}$^\dagger$ & NOA & Sim & Multi-agent & 6--8 & \checkmark & -- & -- & Gen. \\
S25 & Li et al.\ \cite{li2023}$^\dagger$ & DBO & Sim & Framework-only & 1 & \checkmark & -- & \checkmark & Gen. \\
S26 & Rao et al.\ \cite{rao2024}$^\dagger$ & GWO & Sim & Framework-only & 1 & \checkmark & -- & -- & Gen. \\
S27 & Zhang \& Zhang \cite{zhang2022loc}$^\dagger$ & PSO & Sim & Framework-only & 2+ & \checkmark & -- & \checkmark & Gen. \\
S28 & Hu et al.\ \cite{hu2025}$^\dagger$ & PSO & Sim & Multi-agent & 6--7 & \checkmark & -- & \checkmark & Gen. \\
S29 & Zuo et al.\ \cite{zuo2025}$^\dagger$ & APF+PSO & Sim & Multi-agent & 5--25 & \checkmark & -- & \checkmark & Gen. \\
S30 & Yang et al.\ \cite{yang2025}$^\dagger$ & DOA & Sim & Framework-only & 1 & \checkmark & -- & -- & Gen. \\
...
S33 & Li et al.\ \cite{li2025}$^\dagger$ & ACO & S+T & Framework-only & 1 & -- & \checkmark & \checkmark & Gen. \\
\midrule
\multicolumn{2}{l}{\textbf{Summary (n=33)}} & PSO: 10 (30.3\%) & Sim: 24 (72.7\%), S+T: 2 (6.1\%) & Multi: 8 (24.2\%) & 1--25 & 14 (42.4\%) & 6$^{\ddagger}$ (18.2\%) & 7 (21.2\%) & \\
\multicolumn{2}{l}{\textbf{Primary only (n=26)}} & PSO: 10 (38.5\%) & Sim: 24 (92.3\%) & Multi: 8 (30.8\%) & 1--25 & 14 (53.8\%) & 6$^{\ddagger}$ (23.1\%) & 7 (26.9\%) & \\
\bottomrule
...
\caption{Distribution of swarm intelligence algorithms across 33 reviewed studies (2021--2025). PSO dominates with 10 papers (30.3\% of the full corpus; 38.5\% of the 26 primary research studies), followed by review articles (21.2\%) and ACO variants (9.1\%). ``Other SI Variants'' (5 papers, 15.2\%) includes SFLA, Fuzzy/SIGPAF, Wolf Pack, Hybrid ABC+BAS, and GA+ABC hybrid; PSO+ACO (S06) and APF+PSO (S29) are classified under PSO.}
...
%% CORRECCIÃ“N t8a: Se reportan ambas tasas (n=33 y n=26) con denominadores explícitos.
...
%% ============================================================
%% TABLE: Quantitative Metric Reporting by Algorithm Family
%% Verificada contra datos de Table 2 (tab:study_chars).
%% Insertada en Section 4.2, después de Table~\ref{tab:metrics}
%% y antes de Section 4.3 (Temporal Distribution).
%% ============================================================

\begin{table}[htbp]
\centering
\caption{Metric reporting completeness by SI algorithm family across 26 primary
research studies (review articles S10, S11, S14, S15, S17, S31, S32 excluded).
T = execution time reported; E = energy consumption reported (hardware measurement
or simulation estimate; see note below Table~\ref{tab:study_chars});
C = convergence criteria specified. Score\textsubscript{$\mu$} = mean number of
metrics reported per study (range 0--3). Cells show count of studies reporting the
metric / total in family (\%). All 3 = studies reporting T, E, and C simultaneously.
Families with $n \geq 2$ primary studies are listed individually; singleton
algorithms are grouped below the dividing rule.}
...
\midrule
PSO (hybrids)$^{a}$
  & S06, S09, S12, S13, S16, S20, S23, S27, S28, S29
  & 10 & 80.0 & 20.0 & 70.0 & 1$^{\ddagger}$ & 1.7 \\
ACO
  & S01, S19, S33
  & 3  & 100.0 & 33.3 & 100.0 & 1$^{\S}$ & 2.3 \\
ABC (hybrids)$^{b}$
  & S02, S04, S18, S22
  & 4  & 100.0 & 50.0 & 50.0 & 0 & 2.0 \\
SSA (hybrid)
  & S03, S05
  & 2  & 100.0 & 0.0  & 50.0 & 0 & 1.5 \\
Other SI$^{c}$
  & S07, S08, S21
  & 3  & 33.3 & 33.3 & 33.3 & 1$^{\P}$ & 1.0 \\
\midrule
GWO & S26 & 1 & 100.0 & 0.0 & 100.0 & 0 & 2.0 \\
DBO & S25 & 1 & 100.0 & 0.0 & 100.0 & 0 & 2.0 \\
NOA & S24 & 1 & 0.0   & 0.0 & 100.0 & 0 & 1.0 \\
DOA & S30 & 1 & 0.0   & 0.0 & 100.0 & 0 & 1.0 \\
\midrule
\textbf{All primary}
  & S01--S09, S12--S13, S16, S18--S30, S33
  & \textbf{26} & \textbf{53.8} & \textbf{50.0} & \textbf{26.9} & \textbf{1} & \textbf{1.4} \\
\bottomrule
\end{tabularx}
\begin{minipage}{\linewidth}
\scriptsize\medskip
$^{a}$ PSO hybrids classified under PSO per Table~\ref{tab:algorithms}: PSO+ACO (S06), PSO hybrid (S12), APF+PSO (S29).
$^{b}$ ABC hybrids: GA+ABC (S04), ABC+BAS (S22).
$^{c}$ Other SI variants: Fuzzy/SIGPAF (S07), SFLA (S08), Wolf Pack (S21).\\
$^{\ddagger}$ S20 (Ahmed et al.\ 2021) is the only PSO study reporting all three metrics.
$^{\S}$ S33 (Li et al.\ 2025) is the only ACO study reporting all three metrics; it also achieved hardware testbed validation (S+T), the highest validation level in the corpus.
$^{\P}$ S21 (Xu et al.\ 2022, Wolf Pack) reports all three metrics with fleet sizes of 5--15 UAVs, the largest validated swarm in the corpus.\\
Energy column (E) combines direct hardware measurements and simulation-model energy estimates consistent with Table~\ref{tab:metrics}; see note following Table~\ref{tab:study_chars} for distinction.
Singleton Score\textsubscript{$\mu$} values not shown for singletons (insufficient $n$ for meaningful average).
\end{minipage}
\end{table}

Table~\ref{tab:metrics_by_algo} disaggregates metric reporting by algorithm family,
revealing cross-family patterns that aggregate rates obscure. ACO-based studies
achieve the highest mean metric score (Score\textsubscript{$\mu$} = 2.3), consistent
with the constructive solution-building mechanism of ACO: the pheromone update
procedure naturally produces path length and execution time as intermediate values
during solution construction, reducing the additional implementation cost of
reporting these metrics \cite{dorigo2006,chen2021,shafiq2022}. ACO is also the
only multi-study family in which at least one paper reports all three metrics
simultaneously (S33, Li et al.\ 2025), and it is the only family with a study
achieving hardware testbed validation (S+T).

PSO-based studies report execution time at the highest rate among multi-study
families (80.0\%), above the corpus average (53.8\% over 26 primary studies),
consistent with PSO's continuous velocity-update dynamics that make convergence
timing straightforward to record. However, PSO shows the lowest energy reporting
rate (20.0\%), likely because the velocity-based path representation does not
naturally generate energy estimates without an explicit battery discharge model---a
model that only one of the ten PSO studies in the corpus incorporates. The single
PSO study reporting all three metrics (S20, Ahmed et al.\ 2021) also achieves the
highest fleet size among PSO studies (4 UAVs with genuine multi-agent validation).

ABC-based studies achieve the second-highest mean score (Score\textsubscript{$\mu$}
= 2.0) with perfect execution time reporting (100.0\%) and moderate energy
reporting (50.0\%), but no study in this family achieves simultaneous three-metric
reporting---a consequence of the binary scout/employed bee division that naturally
separates convergence analysis from energy profiling in ABC implementations.

The four singleton families---GWO, DBO, NOA, and DOA---each appear in exactly one
primary study, making within-family cross-study comparison impossible by construction.
This underrepresentation reflects the publication lag between algorithm introduction
and agricultural UAV adoption documented in Section~4.1, and directly motivates the
AgriSwarm-Bench leaderboard's requirement that all benchmark submissions report the
full six-metric suite (Section~7.2): a standardised reporting requirement is the
only mechanism capable of enabling comparison when family sample sizes are this small.
Critically, no study in any algorithm family---PSO, ACO, ABC, SSA, or any
singleton---reports all three standard metrics alongside an agricultural-domain metric
such as coverage rate per hectare or spray overlap coefficient, confirming that the
metric fragmentation documented at the corpus level persists uniformly across every
evaluated algorithm family.

\subsection{Temporal Distribution}
Table~\ref{tab:temporal} shows that publications concentrate in 2021--2022 (23 of 33 papers, 69.7\%), with a marked dip in 2023 (3 papers, 9.1\%) and 2024 (1 paper, 3.0\%), followed by a resurgence in 2025 (6 papers, 18.2\%). The combined 2023--2024 count of 4 papers (12.1\%) contrasts sharply with the 23-paper (69.7\%) volume of 2021--2022. The 2021--2022 peak coincides with post-pandemic acceleration of agricultural automation investment and the proliferation of new SI algorithm variants applied to UAV scenarios. The 2023--2024 trough may reflect a quality filter effect: as the field matured and reviewers demanded stronger experimental validation, fewer simulation-only papers cleared the bar at high-impact venues. The 2025 resurgence, with a higher proportion of hardware-related components, tentatively supports this interpretation. However, 2025 data should be treated with caution: the literature search was conducted on 2026-03-16, and indexing lags of 3--6 months at major databases mean that the 6 papers captured represent a lower bound for 2025 output.
...
\textbf{Note on gap derivation for studies S20--S33.} 57 of the 171 gaps (33.3\%) assigned to studies S20--S33 were derived from automated PDF extraction combined with algorithmic pattern matching, rather than extracted directly from explicit author statements. Metric-level evidence from the extraction pipeline (\texttt{extraer\_metricas\_v2.py}) confirmed quantitative values for execution time, energy consumption, or convergence criteria in all 13 affected primary studies. The four gaps previously flagged as ``pattern-derived'' for study S20 (Ahmed et al., 2021, DOI:~10.3390/app11083417) have been verified against the full-text PDF and are confirmed: (1)~absence of hardware or field validation---the study is exclusively simulation-based in MATLAB with no physical testbed (Section~5 of S20); (2)~absence of real wind or weather modelling---environmental risk is approximated as a randomly generated scalar rather than a physics-based model (Section~3.2.2 of S20: ``for removing complexity, we randomly generated an environmental risk value''); (3)~no scalability assessment beyond four UAVs in grids up to $30\times30$ cells; and (4)~absence of cross-algorithm baseline comparison---the only comparison is between standard PSO and a parameter-tuned variant (mPSO), with no evaluation against ACO, ABC, or other SI methods (Table~3 of S20). All 57 pattern-assisted gap assignments are now fully verified against primary PDF evidence; no ``pattern-derived'' flags remain in the gap taxonomy. A sensitivity analysis excluding all 57 originally pattern-assisted gaps confirms that the dimensional distribution remains stable: Practical gaps retain the highest frequency (35 of 114 directly-extracted gaps, 30.7\%), and the relative ordering of all four dimensions is unchanged.
...
5 & No metric standardisation       & 18 & 54.5 & \\
...
First, the dominance of Particle Swarm Optimization (PSO, 10 of 33 studies, 30.3\%; 10 of 26 primary studies, 38.5\%) reflects the algorithm's computational tractability for multi-dimensional continuous path planning spaces, consistent with prior surveys in adjacent domains \cite{puente2022,sharma2022}. However, the concentration of research around a single algorithm family limits algorithmic diversity and may introduce a publication bias favoring PSO-positive results. The relative underrepresentation of more recent algorithms such as the Dung Beetle Optimizer \cite{li2023} and Nutcracker Optimization Algorithm \cite{xiao2025} (1 study each, 3.0\% of the full corpus, 3.8\% of primary studies) suggests these newer bio-inspired methods have not yet been systematically evaluated against established baselines in agricultural contexts.

Second, the temporal distribution reveals a publication dip in 2023--2024 (4 of 33 papers, 12.1\%) sandwiched between the 2021--2022 peak (23 of 33 papers, 69.7\%) and a 2025 resurgence (6 of 33 papers, 18.2\%). This pattern likely reflects a maturation cycle: the initial wave of studies applied existing SI algorithms to agricultural UAV scenarios without fundamental methodological innovation, after which the community paused to address the standardisation and validation deficits now documented in this review. The 2025 figures should be interpreted cautiously, as the literature search was conducted on 2026-03-16, meaning 2025 coverage may be incomplete due to indexing lags.

Third, the Deployment Readiness Score (DRS) assessment reveals that only 5 of 33 studies (15.2\%) achieved High-DRS ratings ($Q \geq 0.70$), with 18 of 33 studies (54.5\%) classified as Low-DRS primarily due to absent real-world validation (C1 = 0.0 for all simulation-only studies) and incomplete metadata. This distribution reflects the field's structural simulation orientation rather than methodological deficiency: as detailed in Section~\ref{subsec:drs}, a simulation study can be methodologically rigorous while still scoring Low on the DRS because it cannot provide deployment-relevant evidence about hardware behaviour under field conditions. This interpretation is confirmed by the complementary MMAT assessment (Section~\ref{subsec:mmat}), which measures general methodological quality and yields a substantially more favourable distribution (15 of 33 High, 45.5\%; 16 of 33 Moderate, 48.5\%; 2 of 33 Low, 6.1\%). The divergence between the DRS and MMAT distributions is substantively meaningful: it quantifies the gap between methodological rigour (adequate, per MMAT) and deployment readiness (insufficient, per DRS), mirroring findings from systematic reviews in adjacent robotics domains where simulation-to-field transfer remains the central challenge \cite{brambilla2013}.

\subsection{The Field Validation Gap: Structural Barriers and Pathways Forward}

The predominance of simulation-only studies---26 of 33 included studies (78.8\%); equivalently, all 26 primary research studies (100\%)---is the most frequently cited limitation in this corpus and has direct implications for agricultural practitioners seeking to deploy swarm-based UAV systems. This validation gap is not unique to SI-based aerial systems: concurrent work published in this journal on multi-vehicle ground-based plant protection scheduling similarly operates at the simulation and task-model level \cite{xu2025orchard}, suggesting that the gap reflects a broader structural challenge in agricultural robotics rather than a limitation specific to swarm intelligence or aerial platforms. Three structural barriers collectively explain this gap, each requiring distinct interventions.

\textbf{Economic barriers.} Agricultural-grade UAV platforms capable of multi-agent coordination---equipped with GPS RTK, onboard compute for SI algorithms, and inter-UAV communication modules---typically cost between USD~2{,}000 and 15{,}000 per unit \cite{phung2021}. A minimal swarm of five UAVs therefore requires USD~10{,}000--75{,}000 in hardware investment, before accounting for field infrastructure, regulatory compliance, and personnel. This cost is prohibitive for individual research groups at institutions without dedicated robotics laboratories, explaining the geographic concentration of hardware-validated studies in countries with established agricultural technology funding programmes.
...
The absence of wind and weather modeling in 25 of 33 included studies (75.8\%) represents a particularly acute gap for agricultural applications compared to other UAV domains. In search-and-rescue or infrastructure inspection scenarios, UAVs typically operate at altitudes ($>$50\,m) where wind profiles are relatively stable and predictable. In precision agriculture, however, low-altitude operations (2--15\,m above crop canopy for spraying; 30--50\,m for mapping) place UAVs in the atmospheric boundary layer where wind speed and direction are highly variable due to terrain effects, thermal gradients, and crop-generated turbulence.

For spraying applications specifically, wind drift of pesticide or fertilizer droplets is both an efficacy issue and a regulatory compliance issue. Buffer zones from water bodies must be respected in multiple jurisdictions, and wind-induced drift directly affects compliance. None of the 10 spraying-focused primary studies in this corpus model this regulatory constraint, meaning their path planning solutions cannot be directly implemented in many agricultural contexts without modification.
...
The metric reporting analysis reveals a fragmented landscape that fundamentally prevents evidence-based algorithm selection for agricultural deployment. Over the full corpus of 33 studies, only 14 (42.4\%) report execution time, 13 (39.4\%) report energy consumption, and 7 (21.2\%) specify convergence criteria; over the 26 primary research studies, these rates are 14 of 26 (53.8\%), 13 of 26 (50.0\%), and 7 of 26 (26.9\%), respectively. No study reports all three simultaneously alongside field-relevant metrics such as coverage rate per hectare or mission completion probability under communication failures.
...
Most reviewed studies evaluate their proposed algorithms on small UAV fleets of 2--5 agents in simulation environments covering less than 10\,ha. Real precision agriculture operations routinely involve fields of 100--1,000+\,ha where 10--50 UAVs may be required for time-efficient coverage. The scalability gap (identified in 14 of 33 studies, 42.4\%) therefore represents not just a theoretical limitation but a practical disqualifier for deployment at agricultural scale.

Furthermore, 22 of 33 studies (66.7\%) use homogeneous UAV fleets despite the operational reality of agricultural systems where different UAV types---fixed-wing for large-area mapping, multirotor for spraying, hybrid for versatility---are used in coordination. Heterogeneous fleet coordination introduces qualitatively different optimization challenges: different flight envelopes, communication protocols, charging requirements, and task capabilities that current SI frameworks for agricultural UAVs do not address.

\subsection{Comparison with Adjacent Domains and Implications for the Field}
\label{sec:comparison}

To contextualise the validation rates observed in this review (2 of 33 studies, 6.1\%, with any hardware validation), it is informative to compare with adjacent robotics application domains where SI-based multi-robot coordination has been deployed in the field. In search-and-rescue robotics, hardware validation rates in recent systematic reviews range from 40--60\% \cite{chung2018}, partly because the urgency of the application domain creates institutional incentives for field testing. In infrastructure inspection, validation rates are similarly higher due to industry partnerships that provide field access \cite{brambilla2013}.

The relatively low validation rate in agricultural UAV SI research (6.1\% with any hardware component; 0\% with full field validation among primary studies) suggests that the field has developed primarily as a sub-discipline of computational intelligence rather than as an applied robotics discipline. The publication incentive structure---where simulation-only papers are publishable in high-impact journals---has historically not penalised the absence of field validation. The DRS framework introduced in this review, which assigns maximum weight (30\%) to experimental validation (criterion C1), is intended to model the weighting that the community should adopt in peer review.

\subsection{Limitations of This Review}
\label{sec:limitations_discussion}

Several limitations of this systematic review must be acknowledged. First, the search was restricted to English-language publications in three databases (IEEE Xplore, ScienceDirect, SpringerLink), which may have excluded relevant work published in Chinese, Spanish, or other languages, or in domain-specific agricultural engineering databases such as CAB Abstracts or AGRIS. Second, title and abstract screening was performed by the primary reviewer only; while full-text assessment achieved near-perfect inter-rater agreement ($\kappa=0.91$), the absence of dual screening at the title/abstract stage represents a methodological limitation that may have introduced selection bias at that phase. Third, 57 of the 171 documented gaps (33.3\%) assigned to studies S20--S33 were derived from automated PDF extraction combined with pattern matching; all 57 assignments have since been verified against primary full-text PDF evidence, including the four gaps for study S20 (Ahmed et al., 2021), which are confirmed by direct textual evidence (see Section~5.1 and Supplementary Material~S2). Fourth, the DRS instrument (Table~\ref{tab:quality_criteria}) has not been validated as a psychometric tool; its criterion weights (C1: 30\%, C2: 25\%, C3: 25\%, C4: 20\%) represent domain-informed expert judgment and reflect a normative stance that field validation is the primary criterion for deployment-relevant research, rather than a neutral methodological quality evaluation. Fifth, the Gap~3 finding (22 of 33 studies with single-UAV experimental focus despite multi-UAV framing) may in part reflect a limitation of the inclusion criteria rather than a gap in the field exclusively: the leniency in criterion I4/E3 permitted entry of studies that validated multi-UAV frameworks with single agents, inflating the apparent frequency of this gap. There is a circularity risk in this finding: the review explicitly targets multi-UAV systems (PICOC Population), which means studies that only implement single-agent experiments were already borderline inclusions; retaining them under I4b while then classifying their single-agent evaluation as a ``gap'' partially constructs the gap through the inclusion decision. This circularity is disclosed as a transparency issue; the Gap~3 frequency (22 of 33, 66.7\%) should be interpreted as an upper bound. Future reviews should either tighten E3 to exclude single-agent-only studies entirely or stratify the corpus, reporting gap prevalence separately for genuinely multi-agent and framework-only studies.
...
Table~\ref{tab:threats} summarises the principal threats to the validity of this review and the mitigation strategies applied.
...
Inter-rater variability & Single reviewer for T/A screening introduces selection bias & Declared as limitation (Sec.~8.3); second reviewer screens all 51 full-text records; $\kappa=0.91$ reported \\[4pt]
Temporal bias (2025) & 2025 data may be incomplete due to indexing lag & Explicitly noted; 2025 papers treated as preliminary indicator only \\[4pt]
Inferred gaps & 57 gaps initially derived from automated pattern matching (studies S20--S33) & All 57 have been manually verified against full-text PDFs; no pattern-derived flags remain in the gap database (see Sec.~5.1 \& Supp.~Mat.~S2) \\
\bottomrule
\end{tabularx}
\end{table}
...
51 full-text records, not to the 481 records screened at title/abstract stage.
  \item \textbf{Gap derivation for studies S20--S33:} 57 of the 171 documented gaps (33.3\%) assigned to studies S20--S33 were derived from automated PDF extraction combined with algorithmic pattern matching. Metric-level evidence from the extraction pipeline (\texttt{extraer\_metricas\_v2.py}) confirmed quantitative values for execution time, energy consumption, or convergence criteria in 12 of the 13 affected primary studies. All four gaps previously flagged as ``pattern-derived'' for study S20 (Ahmed et al., 2021) have been verified against the full-text PDF (DOI:~10.3390/app11083417) and confirmed: simulation-only validation, absence of wind modelling, no scalability analysis beyond four UAVs, and no cross-algorithm SI comparison. No ``pattern-derived'' assignments remain in the gap taxonomy.
    \item \textbf{MMAT assessments completed:} Two studies (S32, S33) have been verified and classified as High (both High). See Supplementary Table~S5 for detailed scores.
...
\begin{enumerate}
  \item \textbf{Gap validation for S20 completed:} The four gaps assigned to study S20, previously flagged as pattern-derived, have been verified against the full-text PDF (Ahmed et al., 2021, \textit{Distributed 3-D Path Planning for Multi-UAVs with Full Area Surveillance Based on Particle Swarm Optimization}, DOI:~10.3390/app11083417) and confirmed by direct textual evidence. All gap assignments for studies S20--S33 are now fully verified against primary PDF evidence; no pattern-derived flags remain in the gap taxonomy.
  ...
  \item \textbf{Extend MMAT to future corpus additions:} As the AgriSwarm-Bench community contributes new benchmark studies, MMAT assessments should be applied systematically using the same instrument (version 2018) and codebook established in this review, enabling longitudinal tracking of methodological quality trends in the SI-based agricultural UAV literature.
...
%% ============================================================
%% FUNDING (Elsevier requirement: separate from Acknowledgments)
%% ============================================================
\section*{Funding}
This research was supported by Instituto Tecnológico de Chihuahua II, Universidad Politécnica de Chihuahua, and Universidad de Zaragoza. The funders had no role in study design, data collection, analysis, decision to publish, or manuscript preparation.

%% ============================================================
%% ACKNOWLEDGMENTS
%% ============================================================
\section*{Acknowledgments}
The authors thank the doctoral program in Ingeniería en Ciencias de la Ingeniería (TecNM) for academic guidance and peer feedback during manuscript development.
