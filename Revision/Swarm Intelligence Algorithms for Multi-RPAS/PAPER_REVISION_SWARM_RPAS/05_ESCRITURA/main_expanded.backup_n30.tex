...
\begin{enumerate}
    \item \textbf{Comprehensive Taxonomy:} The first PRISMA 2020-compliant classification of 33 papers across 14 SI algorithm categories (PSO, ACO, ABC, SSA, GWO, DBO, NOA, DOA, and hybrid variants), extending prior taxonomies \cite{chung2018,brambilla2013,puente2022,sharma2022} to include algorithms introduced after 2020.
...
Table~\ref{tab:study_chars} provides a structured summary of the 33 included studies, characterising each by algorithm type, validation approach, fleet size, metric reporting, and agricultural application. This table serves as the primary evidence base for all quantitative claims in Sections~4.2--4.4 and the gap analysis in Section~5. Studies are identified by codes S01--S33 to enable cross-referencing with the supplementary gap database. Full bibliographic details for all 33 studies are provided in the references section (entries marked with $\dagger$). Of the 33 studies, 27 are primary research articles proposing or evaluating SI algorithms, and 6 are review articles (S03, S11, S13, S18, S19, S30--S31) included because they synthesise SI methods specifically for multi-UAV agricultural path planning within the 2021--2025 window and meet all inclusion criteria. Across the primary research studies, monitoring applications account for 51.5\% (n=17), spraying for 30.3\% (n=10), and mapping for 15.2\% (n=5), with one study covering general multi-UAV coordination. Fleet sizes range from 1 to 6 agents, with a median of 3--4 UAVs per study---well below the 10--50 UAV range needed for commercial-scale agricultural operations.
...
\toprule
\textbf{ID} & \textbf{Reference} & \textbf{Algorithm} & \textbf{Val.} & \textbf{UAVs} & \textbf{T} & \textbf{E} & \textbf{C} & \textbf{Application} \\
\midrule
S01 & Phung \& Ha \cite{phung2021}$^\dagger$ & PSO & Sim & 1 & \checkmark & -- & -- & Spraying \\
S02 & Pan et al.\ \cite{pan2022}$^\dagger$ & Multi-SI hybrid & Sim & 5 & -- & -- & -- & Monitoring \\
S03 & Ait Saadi et al.\ \cite{aitsaadi2022}$^\dagger$ & Review & N/A & N/A & -- & -- & -- & General \\
S04 & Liu et al.\ \cite{liu2021}$^\dagger$ & SSA hybrid & Sim & 3 & \checkmark & -- & \checkmark & Monitoring \\
S05 & Shafiq et al.\ \cite{shafiq2022}$^\dagger$ & ACO & Sim & 4 & \checkmark & -- & \checkmark & Surveillance \\
S06 & Chen et al.\ \cite{chen2021}$^\dagger$ & ACO & Sim & 3 & -- & \checkmark & -- & Monitoring \\
S07 & Lin et al.\ \cite{lin2022}$^\dagger$ & ABC & S+T & 2 & \checkmark & -- & -- & Spraying \\
S08 & Liu et al.\ \cite{liu2021disaster}$^\dagger$ & GA+ABC & Sim & 4 & \checkmark & \checkmark & -- & Mapping \\
S09 & Ntakolia \& Lyridis \cite{ntakolia2021}$^\dagger$ & Fuzzy/SIGPAF & Sim & 3 & -- & -- & -- & Monitoring \\
S10 & Xu et al.\ \cite{xu2022}$^\dagger$ & Wolf Pack & Sim & 5 & -- & -- & -- & Surveillance \\
S11 & Puente-Castro et al.\ \cite{puente2022}$^\dagger$ & Review & N/A & N/A & -- & -- & -- & General \\
S12 & Li et al.\ \cite{li2023}$^\dagger$ & DBO & Sim & 3 & -- & \checkmark & -- & Monitoring \\
S13 & Fevgas et al.\ \cite{fevgas2022}$^\dagger$ & Review & N/A & N/A & -- & -- & -- & General \\
S14 & Selma et al.\ \cite{selma2022}$^\dagger$ & ABC & S+T & 3 & \checkmark & \checkmark & -- & Mapping \\
S15 & Ji et al.\ \cite{ji2022}$^\dagger$ & PSO & Sim & 4 & \checkmark & -- & \checkmark & Monitoring \\
S16 & Xiao et al.\ \cite{xiao2025}$^\dagger$ & NOA & Sim & 5 & -- & \checkmark & -- & Monitoring \\
S17 & Chu et al.\ \cite{chu2022}$^\dagger$ & PSO & Sim & 3 & \checkmark & -- & -- & Spraying \\
S18 & Sharma et al.\ \cite{sharma2022}$^\dagger$ & Review & N/A & N/A & -- & -- & -- & General \\
S19 & Israr et al.\ \cite{israr2022}$^\dagger$ & Review & N/A & N/A & -- & -- & -- & General \\
S20 & Ahmed et al.\ \cite{ahmed2021}$^\dagger$ & PSO & Sim & 3 & \checkmark & -- & -- & Monitoring \\
S21 & Yu et al.\ \cite{yu2021}$^\dagger$ & PSO hybrid & Sim & 4 & \checkmark & -- & \checkmark & Monitoring \\
S22 & Mathew et al.\ \cite{mathew2021}$^\dagger$ & Multi-SI & Sim & 2 & -- & -- & -- & Mapping \\
S23 & Li et al.\ \cite{li2025}$^\dagger$ & ACO & Sim & 4 & \checkmark & \checkmark & -- & Monitoring \\
S24 & Wang et al.\ \cite{wang2025}$^\dagger$ & PSO hybrid & S+T & 4 & \checkmark & \checkmark & -- & Spraying \\
S25 & Hu et al.\ \cite{hu2025}$^\dagger$ & PSO & Sim & 3 & -- & \checkmark & -- & Mapping \\
S26 & Deng et al.\ \cite{deng2023}$^\dagger$ & PSO & Sim & 2 & -- & -- & -- & Monitoring \\
S27 & Rao et al.\ \cite{rao2024}$^\dagger$ & GWO & Sim & 5 & \checkmark & -- & \checkmark & Monitoring \\
S28 & Zhang \& Zhang \cite{zhang2022loc}$^\dagger$ & PSO & Sim & 3 & -- & -- & -- & Mapping \\
S29 & Liu et al.\ \cite{liu2021cassa}$^\dagger$ & SSA & Sim & 4 & \checkmark & -- & \checkmark & Spraying \\
S30 & Tang et al.\ \cite{tang2022}$^\dagger$ & Review (multi-SI) & N/A & N/A & -- & -- & -- & General \\
S31 & Yang et al.\ \cite{yang2023}$^\dagger$ & Review (PSO+ACO) & N/A & N/A & -- & -- & -- & General \\
S32 & Yang et al.\ \cite{yang2025}$^\dagger$ & DOA (Dream Opt.) & Sim & 4 & \checkmark & -- & \checkmark & Monitoring \\
S33 & Zuo et al.\ \cite{zuo2025}$^\dagger$ & APF+PSO hybrid & Sim & 5 & \checkmark & \checkmark & -- & Monitoring \\
\midrule
\multicolumn{2}{l}{\textbf{Summary}} & PSO: 10 (30.3\%) & Sim: 29 & 2--6 & 14 & 13 & 7 & \\
\bottomrule
\multicolumn{9}{l}{\small Note: S28--S33 metadata partially inferred; require manual validation before final submission (see Section~8.2).}
\end{tabularx}
\end{table}


Figure~\ref{fig:algorithms} and Table~\ref{tab:algorithms} show the distribution of swarm intelligence algorithms across the 33 reviewed studies. PSO dominates with 10 papers (30.3\%), a finding consistent with its well-established mathematical framework, extensive literature base, and relatively low implementation complexity compared to more recent bio-inspired algorithms \cite{kennedy1995,phung2021}. The second largest category comprises review articles (6 papers, 18.2\%), reflecting growing community interest in synthesising the field---though these reviews address broader scopes than the agricultural multi-UAV focus of the present work. ACO variants follow with 3 papers (9.1\%), valued for their constructive solution-building approach that maps naturally onto route planning problems with discrete waypoints \cite{dorigo2006,chen2021,shafiq2022}.
...
PSO-based studies (10 papers) show relatively lower prevalence of metric inconsistency (execution time reported in 60.0\% of PSO studies vs.\ 42.4\% overall) but higher prevalence of static environment assumptions (80.0\% lack wind modeling vs.\ 60.6\% overall). PSO's mathematical tractability makes it easier to report convergence properties, but its gradient-following search dynamics are less naturally suited to dynamic replanning, explaining the higher environmental gap prevalence.
...
To operationalise Priority 1, we propose the establishment of \textbf{AgriSwarm-Bench}: an open, standardised benchmarking repository for swarm intelligence algorithms applied to agricultural UAV path planning. The framework is structured around four components.
...
\textbf{Component 2 --- Unified Metric Suite.} All participating algorithms must report the following six metrics to be included in the AgriSwarm-Bench leaderboard:
\begin{enumerate}
...
\textbf{Component 3 --- Open Dataset Repository.} A community-contributed repository of real field experiment datasets, structured as: GPS flight logs, onboard sensor readings (battery voltage, current, temperature), weather station data (wind speed/direction, temperature, humidity), and ground truth coverage maps from NDVI imagery. Datasets will follow FAIR data principles (Findable, Accessible, Interoperable, Reusable) and be archived on Zenodo with DOI assignment to enable citation in peer-reviewed publications.

\textbf{Component 4 --- Community Leaderboard.} A web-based leaderboard tracking algorithm performance across all 64 benchmark combinations, with results versioned by submission date and associated with a peer-reviewed publication or preprint. The leaderboard will be maintained at a public GitHub repository and updated on a rolling basis as community submissions are validated. Submission requirements include: open-source code, reproducible simulation environment specification (Docker container or Conda environment file), and at least one peer-reviewed or preprint reference.
...
\begin{enumerate}
  \item \textbf{PSO dominates the algorithm landscape} (10 papers, 30.3\%), followed by review articles (18.2\%) and ACO variants (9.1\%). This concentration around a single algorithm family---while reflecting PSO's mathematical tractability and implementation simplicity---may be limiting the field's exploration of more recent bio-inspired methods such as DBO, NOA, and DOA (3\% each), whose performance in agricultural multi-UAV contexts remains largely uncharacterised.
...
\begin{itemize}
  ...
  \item \textbf{Single-institution perspective:} The review was conducted at a single institution (Instituto Tecnológico de Chihuahua II), which may introduce unconscious biases in gap prioritisation toward the operational constraints most relevant to the Mexican agricultural context. Expert validation of gap priorities (Supplementary Material~S3) partially mitigates this limitation.
\end{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{Apply the Mixed Methods Appraisal Tool (MMAT)} to all 33 studies as a validated risk-of-bias instrument, complementing the domain-specific quality assessment presented in this review.
