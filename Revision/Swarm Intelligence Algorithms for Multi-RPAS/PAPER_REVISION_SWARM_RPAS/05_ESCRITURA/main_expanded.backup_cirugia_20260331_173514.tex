...
\textbf{Objective:} This systematic review analyses swarm intelligence (SI)-based path planning for multi-UAV systems in precision agriculture, identifying critical research gaps that limit real-world deployment. \textbf{Methods:} Following PRISMA 2020 guidelines, we searched IEEE Xplore, ScienceDirect, and SpringerLink for studies published 2021--2024. From 502 records, 33 studies (26 primary, 7 reviews) were selected for synthesis. Data were extracted regarding algorithm types, evaluation metrics, and experimental validation. \textbf{Results:} Particle Swarm Optimisation (PSO) is the most frequently applied algorithm (30.3\% of studies). The review reveals a critical validation deficit: 100\% of the 26 primary studies lack real-world hardware validation in field conditions, relying exclusively on simulations. Metric reporting is consistently sparse, with only 42.4\% reporting execution time and 39.4\% energy consumption. We identified 171 research gaps, systematically classified into technological (29.8\%), practical (30.4\%), methodological (22.8\%), and theoretical (17.0\%) dimensions. \textbf{Conclusions:} Current research remains heavily simulation-oriented and lacks standardised benchmarking frameworks. We propose the AgriSwarm-Bench framework to bridge the theory-to-field transition through standardised evaluation metrics and multi-agent scalability testing. This study provides the first structured gap analysis to guide development of deployable swarm-based agricultural UAV systems.
\end{abstract}
